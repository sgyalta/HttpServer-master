...
namespace Server.Helpers
{
    class RepairCookies
    {
        ...
        public static CookieContainer ObjCookieContainer { get; } = new CookieContainer();
        ...
        private static ArrayList ConvertCookieHeaderToArrayList(string strCookHeader)
        {
            ...
            while (strCookHeader.StartsWith(","))
            {
                //    if (strCookHeader.StartsWith(","))
                strCookHeader = strCookHeader.Remove(0, 1);
            }
            ...
            while (i < n)
            {
                if (strCookTemp[i].IndexOf("expires=", StringComparison.OrdinalIgnoreCase) > 0)
                {
                    ...
                    al.Add(strCookTemp[i] + strCookTemp[i + 1].TrimEnd(',') + ";");
                    al.RemoveAt(i + 1);
                    i = i + 1;
                }
                else
